...
const SOURCE_KEYS = 'id qualificationSystemKey label governingBody sport sports qualificationEvents sourceTier kind status url rulesUrl iocDocuments allocationUrl entryUrl refreshPolicy sourceCheckMode sourceCheckReason checkStatus checkedAt available httpStatus resolvedUrl lastSuccessfulAt healthCheckFailedAt'.split(' ');
